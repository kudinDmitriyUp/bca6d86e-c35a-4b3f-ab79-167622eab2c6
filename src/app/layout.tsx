...
export const metadata: Metadata = {
  title: "Noya's Dog Fund - Help Me Get My Dream Big Dog",
  description: "Support Noya's campaign to adopt and care for a big dog - Border Collie, Golden Retriever, or Bernese Mountain Dog. Every donation helps!",
  keywords: "dog donation, pet adoption, big dogs, Border Collie, Golden Retriever, Bernese Mountain Dog, fundraising, animal welfare",
  metadataBase: new URL("https://noyasdogfund.com"),
  alternates: {
    canonical: "https://noyasdogfund.com"
  },
  openGraph: {
    title: "Help Noya Get Her Dream Big Dog",
    description: "Support this heartwarming campaign to help Noya adopt and care for a big dog companion",
    siteName: "Noya's Dog Fund",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763219106858-oq7uebpu.jpg",
      alt: "Noya's Dog Adoption Campaign"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Help Noya Get Her Dream Big Dog",
    description: "Support this heartwarming campaign to help Noya adopt and care for a big dog companion",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763219106858-oq7uebpu.jpg"]
  },
  robots: {
    index: true,
    follow: true
